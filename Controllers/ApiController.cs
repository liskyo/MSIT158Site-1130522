...
namespace MSIT158Site.Controllers
{
    public class ApiController : Controller
    {
        ...
        private readonly IWebHostEnvironment _hostEnvironment;  //注入
        ...
        //MyDBContext context：資料庫上下文，用於與資料庫進行交互。
        //IWebHostEnvironment hostEnvironment：主機環境，用於獲取有關應用程式運行環境的信息，比如內容根目錄和 Web 根目錄。
